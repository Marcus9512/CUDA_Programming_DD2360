...
const char *mykernel = 
    ...
    "printf(\"Hello World but in OpenCL from thread %d \\n \", thread_index);}\n"; //TODO: Write your kernel here

//kerneal version 2-D 1 work group
const char* mykernel2D1Work =
    "__kernel           \n"
    "void hello_world () \n"
    "{int x = get_global_id(0);\n"
    " int y = get_global_id(1);\n"
    "printf(\"Hello World but in OpenCL from thread (%d, %d) \\n \", x, y);}\n"; //TODO: Write your kernel here

//kerneal version 2-D 4x4 work groups
const char* mykernel2D4Work =
    "__kernel           \n"
    "void hello_world () \n"
    "{int x = get_global_id(0);\n"
    " int y = get_global_id(1);\n"
    ...
    "printf(\"Hello World but in OpenCL from thread Global (%d, %d) Local (%d, %d) \\n \",x, y, lx, ly);}\n"; //TODO: Write your kernel here

//kerneal version 3-D
const char* mykernel3D =
    "__kernel           \n"
    "void hello_world () \n"
    "{int x = get_global_id(0);\n"
    " int y = get_global_id(1);\n"
    ...
    "printf(\"Hello World but in OpenCL from thread Global (%d, %d, %d) Local (%d, %d, %d) \\n \",x, y, z, lx, ly, lz);}\n"; //TODO: Write your kernel here
...
int main(int argc, char *argv) {
  ...
  // 2-D 1 work group
  //cl_program program = clCreateProgramWithSource(context, 1, (const char**)&mykernel2D1Work, NULL, &err);

  // 2-D 4x4 work group
  //cl_program program = clCreateProgramWithSource(context, 1, (const char**)&mykernel2D4Work, NULL, &err);

  // 3-D 
  cl_program program = clCreateProgramWithSource(context, 1, (const char**)&mykernel3D, NULL, &err);
  ...
  */
  ...
  // 2-D 16x16 items 4x4 work group
  /*
  size_t n_workitem[2] = { 16 , 16 };
